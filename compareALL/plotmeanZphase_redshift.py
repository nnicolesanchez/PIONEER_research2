...
ax1.plot(t[0],warm[0]/Z_sun,color=colors[0],label=names[0],linestyle=lines[3])
ax1.plot(t[1],warm[1]/Z_sun,color=colors[1],label=names[1],linestyle=lines[2])
ax1.plot(t[2],warm[2]/Z_sun,color=colors[2],label=names[2],linestyle=lines[1])
ax1.plot(t[3],warm[3]/Z_sun,color=colors[3],label=names[3],linestyle=lines[0])
ax1.plot(t[4],warm[4]/Z_sun,color=colors[4],label=names[4],linestyle=lines[3])
#ax1.plot(t[5],np.log10(warm[5]),color=colors[5],label=names[5],linestyle=lines[2])
ax1.set_ylabel(r'Warm CGM Mean Metallicity [Z$_{\odot}$] (T$^5$ - T$^6$)')
ax1.set_xlabel('Time [Gyr]')
ax1.legend()
...
ax1.plot(t[0],hot[0]/Z_sun,color=colors[0],label=names[0],linestyle=lines[3])
ax1.plot(t[1],hot[1]/Z_sun,color=colors[1],label=names[1],linestyle=lines[2])
ax1.plot(t[2],hot[2]/Z_sun,color=colors[2],label=names[2],linestyle=lines[1])
ax1.plot(t[3],hot[3]/Z_sun,color=colors[3],label=names[3],linestyle=lines[0])
ax1.plot(t[4],hot[4]/Z_sun,color=colors[4],label=names[4],linestyle=lines[3])
#ax1.plot(t[5],np.log10(hot[5]),color=colors[5],label=names[5],linestyle=lines[2])
ax1.set_ylabel(r'Hot CGM Mean Metallicity [Z$_{\odot}$] (T$^6$ - T$^7$)')
ax1.set_xlabel('Time [Gyr]')
ax1.legend()
