...
solid = [0,0.1]
dashed = [0,0.1]
plt.plot(solid,dashed,color='Black',linewidth=wid_BH,label='BH')
plt.plot(solid,dashed,color='Black',linewidth=wid_noBH,label='NO BH')
for k in range(len(labels)):
    ...
    plt.plot(R,np.log10(totgasmass),label=NEW_lab[k],color=colors[k],linestyle=lines[k],linewidth=wid_BH)
...
for j in range(len(labels_noBHs)):
    ...
    plt.plot(noBH_R,np.log10(noBH_totgasmass),color=colors_noBHs[j],linestyle=lines[j],linewidth=wid_noBH)
...
for k in range(len(labels)):
    ...
    R = np.loadtxt(labels[k]+'/'+labels[k]+'_Rbins_'+time+'_'+catalogue+'.np')
    plt.plot(R,np.log10(Omass),label=NEW_lab[k],color=colors[k],linestyle=lines[k],linewidth=wid_BH)
...
for j in range(len(labels_noBHs)):
    ...
    noBH_R = np.loadtxt(labels_noBHs[j]+'/'+labels_noBHs[j]+'_Rbins_'+time+'_'+catalogue+'.np')
    plt.plot(noBH_R,np.log10(noBH_Omass),color=colors_noBHs[j],linestyle=lines[j],linewidth=wid_noBH)
...
for k in range(len(labels)):
    ...
    R = np.loadtxt(labels[k]+'/'+labels[k]+'_Rbins_'+time+'_'+catalogue+'.np')
    plt.plot(R,np.log10(Z/Z_sun),label=NEW_lab[k],color=colors[k],linestyle=lines[k],linewidth=wid_BH)

for j in range(len(labels_noBHs)):
    print('Read in: ',labels_noBHs[j])
    noBH_Z = np.loadtxt(labels_noBHs[j]+'/'+labels_noBHs[j]+'_Z_'+time+'_'+catalogue+'.np')
    noBH_R = np.loadtxt(labels_noBHs[j]+'/'+labels_noBHs[j]+'_Rbins_'+time+'_'+catalogue+'.np')
    plt.plot(noBH_R,np.log10(noBH_Z/Z_sun),color=colors_noBHs[j],linestyle=lines[j],linewidth=wid_noBH)
...
for k in range(len(labels)):
    ...
    R = np.loadtxt(labels[k]+'/'+labels[k]+'_Rbins_'+time+'_'+catalogue+'.np')
    plt.plot(R,T,label=NEW_lab[k],color=colors[k],linestyle=lines[k],linewidth=wid_BH)

for j in range(len(labels_noBHs)):
    print('Read in: ',labels_noBHs[j])
    noBH_T = np.loadtxt(labels_noBHs[j]+'/'+labels_noBHs[j]+'_T_'+time+'_'+catalogue+'.np')
    noBH_R = np.loadtxt(labels_noBHs[j]+'/'+labels_noBHs[j]+'_Rbins_'+time+'_'+catalogue+'.np')
    plt.plot(noBH_R,noBH_T,color=colors_noBHs[j],linestyle=lines[j],linewidth=wid_noBH)
...
#    R = np.loadtxt('/home1/nnsanche/PIONEER_research2/ioniz_species/'+labels[j]+'_Rbins_'+time+'.np')
    plt.plot(R,Novi,label=NEW_lab[j],color=colors[j],linestyle=lines[k],linewidth=wid_BH)
...
#    noBH_R = np.loadtxt('/home1/nnsanche/PIONEER_research2/noBH_analysis/'+NEW_lab_noBHs[j]+'_Rbins_'+time+'.np')
    plt.plot(noBH_R,noBH_Novi,color=colors_noBHs[j],linestyle=lines[j],linewidth=wid_noBH)
...
#    R = np.loadtxt('/home1/nnsanche/PIONEER_research2/ioniz_species/'+labels[j]+'_Rbins_'+time+'.np')
    plt.plot(R,Novii,label=NEW_lab[j],color=colors[j],linestyle=lines[k],linewidth=wid_BH)
...
#    noBH_R = np.loadtxt('/home1/nnsanche/PIONEER_research2/noBH_analysis/'+NEW_lab_noBHs[j]+'_Rbins_'+time+'.np')
    plt.plot(noBH_R,noBH_Novii,color=colors_noBHs[j],linestyle=lines[j],linewidth=wid_noBH)
plt.title('z = 0.17')
...
for j in range(len(labels)):
    ...
    R = np.loadtxt(labels[j]+'/'+labels[j]+'_Rbins_'+time+'_'+catalogue+'.np')
    plt.plot(R,rho,label=NEW_lab[j],color=colors[j],linestyle=lines[k],linewidth=wid_BH)

for j in range(len(labels_noBHs)):
    print('Read in: ',labels_noBHs[j])
    noBH_rho = np.loadtxt(labels_noBHs[j]+'/'+labels_noBHs[j]+'_rho_'+time+'_'+catalogue+'.np')
    noBH_R = np.loadtxt(labels_noBHs[j]+'/'+labels_noBHs[j]+'_Rbins_'+time+'_'+catalogue+'.np')
    plt.plot(noBH_R,noBH_rho,color=colors_noBHs[j],linestyle=lines[j],linewidth=wid_noBH)
