...
for i in range(0,len(dirs)):
 ...
 #           print('Time:',t)
    ...
    plt.plot(time,np.abs(outer_influx_mass),label='Inflow at Rvir',linestyle='-',linewidth=2,color='SteelBlue')
    plt.plot(time,outer_outflux_mass,label='Outflow at Rvir',linestyle=':',linewidth=2,color='SteelBlue')    
    plt.plot(time,np.abs(inner_influx_mass),label='Inflow at 0.1*Rvir',linestyle='-',linewidth=2,color='SkyBlue')
    plt.plot(time,inner_outflux_mass,label='Outflow at 0.1*Rvir',linestyle=':',linewidth=2,color='SkyBlue')
...
#    plt.show()
    ...
    plt.plot(time,np.abs(outer_influx_metal),label='Inflow at Rvir',linestyle='-',linewidth=2,color='SteelBlue')
    plt.plot(time,outer_outflux_metal,label='Outflow at Rvir',linestyle=':',linewidth=2,color='SteelBlue')    
    plt.plot(time,np.abs(inner_influx_metal),label='Inflow at 0.1*Rvir',linestyle='-',linewidth=2,color='SkyBlue')
