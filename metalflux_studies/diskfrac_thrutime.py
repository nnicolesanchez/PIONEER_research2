...
name   = ['P0','GM1','GM2','GM3','P0noBH','GM1noBH','GM2noBH','GM3noBH']
labels = ['P0','GM1','GM2','GM3','P0noBH','GM1noBH','GM2noBH','GM3noBH']
colors = ['SteelBlue','DodgerBlue','FireBrick','Salmon','SteelBlue','DodgerBlue','FireBrick','Salmon']
linestyles=['-','-','-','-','--','--','--','--']
...
#    print(dflux)
    plt.plot(times,dflux,label=labels[i],color=colors[i],linestyle=linestyles[i])

#plt.text(1,0.6,name,size=15)
plt.text(4,0.7,'More metals within 10 kpc')
plt.text(3.9,-0.11,'More metals outside of 10 kpc')
...
plt.ylabel(r'Disk Metal Fraction',fontsize=15)
plt.xlabel('Age of Universe/Gyr',fontsize=15)
plt.ylim(-1,1)
plt.xlim(0,14)
plt.legend()
plt.savefig('diskmetalfrac_thrutime.pdf')
plt.show()
