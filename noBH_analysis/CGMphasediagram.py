...
if len(sys.argv) == 1:
    ...
    if (str(sys.argv[1]) == 'P0'):
        ...
        sim = pynbody.load('/nobackupp2/nnsanche/NO_BHs/pioneer50h243GM5.1536gst1bwK1/pioneer50h243GM5.1536gst1bwK1.00'+ts)
    elif (str(sys.argv[1]) == 'GM6'):
        sim = pynbody.load('/nobackupp2/nnsanche/NO_BHs/pioneer50h243GM6.1536gst1bwK1/pioneer50h243GM6.1536gst1bwK1.00'+ts)
