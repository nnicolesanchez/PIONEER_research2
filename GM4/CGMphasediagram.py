...
plt.scatter(np.log10(CGM_gas['rho'][mini_CGM_gas_mask]),np.log10(CGM_gas['temp'][mini_CGM_gas_mask]),c=np.log10(CGM_gas['metals'][mini_CGM_gas_mask]),cmap=cm.jet, alpha=0.5,s=np.log10(CGM_gas['mass'][mini_CGM_gas_mask]))
